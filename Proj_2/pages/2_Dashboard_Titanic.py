...
st.markdown("- In this way a Titanic dataframe can be shown")
l = ["sex", "who", "embark_town"]
...
# ax.pie(pie, labels = pie.index, autopct = "%1.2f%%")
# plt.show()
# st.pyplot(fig2)

# using plotly library
fig2 = px.pie(df, values=pie, names=pie.index, title="Survived People at diff Category")
